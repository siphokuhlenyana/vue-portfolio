<template lang="">
    <div class="container d-flex justify-content-center ">
        <h1 class="display-2" :style="{marginTop:'20px',color:'black'}"><svg xmlns="http://www.w3.org/2000/svg" width="100" height="150" fill="currentColor" class="bi bi-ear" viewBox="0 0 16 16">
...
<div id="contactme">
    ...
    <form action="Details" netlify
    method ="POST">

    <label for="Name">Name:</label><br>
    <input type="text" id="Name" name="Name" value=""><br>
    <label for="Surname">Surname:</label><br>
    <input type="text" id="lname" name="Surname" value=""><br><br>
    <label for="Message">Message:</label><br>
    <input type="text" id="message" name="Message" value="" placeholder="Your enquiry"><br><br>
    <label for="appo">Set Appointment:</label><br>
