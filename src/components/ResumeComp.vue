<template lang="">
    <div id="container">
     ...
     <div v-show="createView" :style="{borderWidth:'5px',borderColor:'#a300a3',
        borderStyle:'solid',
        backgroundImage:'url(https://siphokuhlenyana.github.io/Vue_projectImages/education.jpg)',backgroundRepeat:'no repeat',backgroundSize:'cover'}">
...
</svg> Soft Skills </h2><h2 :style="{color:'#fad0f9'}">Hard Skills</h2></div>
        <div id="skills">
